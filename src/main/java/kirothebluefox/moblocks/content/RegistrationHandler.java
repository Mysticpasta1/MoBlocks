...
public class RegistrationHandler {
        public static final DeferredRegister BLOCKS = DeferredRegister.create(Registries.BLOCK, MoBlocks.MODID);
        public static final DeferredRegister ITEMS = DeferredRegister.create(Registries.ITEM, MoBlocks.MODID);

		/* Special Blocks */
		/*Arches*/
		public static final Supplier<Block> oak_arch = BLOCKS.register("oak_arch", () ->  new ArchBlock( Blocks.OAK_PLANKS));
		public static final Supplier<Block> spruce_arch = BLOCKS.register("spruce_arch", () ->  new ArchBlock( Blocks.SPRUCE_PLANKS));
		public static final Supplier<Block> birch_arch = BLOCKS.register("birch_arch", () ->  new ArchBlock( Blocks.BIRCH_PLANKS));
		public static final Supplier<Block> jungle_arch = BLOCKS.register("jungle_arch", () ->  new ArchBlock( Blocks.JUNGLE_PLANKS));
		public static final Supplier<Block> acacia_arch = BLOCKS.register("acacia_arch", () ->  new ArchBlock( Blocks.ACACIA_PLANKS));
		public static final Supplier<Block> dark_oak_arch = BLOCKS.register("dark_oak_arch", () ->  new ArchBlock( Blocks.DARK_OAK_PLANKS));
		public static final Supplier<Block> cobblestone_arch = BLOCKS.register("cobblestone_arch", () ->  new ArchBlock( Blocks.COBBLESTONE));
		public static final Supplier<Block> andesite_arch = BLOCKS.register("andesite_arch", () ->  new ArchBlock( Blocks.ANDESITE));
		public static final Supplier<Block> brick_arch = BLOCKS.register("brick_arch", () ->  new ArchBlock( Blocks.BRICKS));
		public static final Supplier<Block> dark_prismarine_arch = BLOCKS.register("dark_prismarine_arch", () ->  new ArchBlock(Blocks.DARK_PRISMARINE));
		public static final Supplier<Block> diorite_arch = BLOCKS.register("diorite_arch", () ->  new ArchBlock( Blocks.DIORITE));
		public static final Supplier<Block> end_stone_brick_arch = BLOCKS.register("end_stone_brick_arch", () ->  new ArchBlock( Blocks.END_STONE_BRICKS));
		public static final Supplier<Block> granite_arch = BLOCKS.register("granite_arch", () ->  new ArchBlock( Blocks.GRANITE));
		public static final Supplier<Block> mossy_cobblestone_arch = BLOCKS.register("mossy_cobblestone_arch", () ->  new ArchBlock( Blocks.MOSSY_COBBLESTONE));
		public static final Supplier<Block> mossy_stone_brick_arch = BLOCKS.register("mossy_stone_brick_arch", () ->  new ArchBlock( Blocks.MOSSY_STONE_BRICKS));
		public static final Supplier<Block> nether_brick_arch = BLOCKS.register("nether_brick_arch", () ->  new ArchBlock( Blocks.NETHER_BRICKS));
		public static final Supplier<Block> polished_andesite_arch = BLOCKS.register("polished_andesite_arch", () ->  new ArchBlock( Blocks.POLISHED_ANDESITE));
		public static final Supplier<Block> polished_granite_arch = BLOCKS.register("polished_granite_arch", () ->  new ArchBlock( Blocks.POLISHED_GRANITE));
		public static final Supplier<Block> polished_diorite_arch = BLOCKS.register("polished_diorite_arch", () ->  new ArchBlock( Blocks.POLISHED_DIORITE));
		public static final Supplier<Block> prismarine_brick_arch = BLOCKS.register("prismarine_brick_arch", () ->  new ArchBlock( Blocks.PRISMARINE_BRICKS));
		public static final Supplier<Block> prismarine_arch = BLOCKS.register("prismarine_arch", () ->  new ArchBlock( Blocks.PRISMARINE));
		public static final Supplier<Block> purpur_arch = BLOCKS.register("purpur_arch", () ->  new ArchBlock( Blocks.PURPUR_BLOCK));
		public static final Supplier<Block> quartz_arch = BLOCKS.register("quartz_arch", () ->  new ArchBlock( Blocks.QUARTZ_BLOCK));
		public static final Supplier<Block> red_nether_brick_arch = BLOCKS.register("red_nether_brick_arch", () ->  new ArchBlock( Blocks.RED_NETHER_BRICKS));
		public static final Supplier<Block> red_sandstone_arch = BLOCKS.register("red_sandstone_arch", () ->  new ArchBlock( Blocks.RED_SANDSTONE));
		public static final Supplier<Block> sandstone_arch = BLOCKS.register("sandstone_arch", () ->  new ArchBlock( Blocks.SANDSTONE));
		public static final Supplier<Block> smooth_quartz_arch = BLOCKS.register("smooth_quartz_arch", () ->  new ArchBlock( Blocks.SMOOTH_QUARTZ));
		public static final Supplier<Block> smooth_red_sandstone_arch = BLOCKS.register("smooth_red_sandstone_arch", () ->  new ArchBlock( Blocks.SMOOTH_RED_SANDSTONE));
		public static final Supplier<Block> smooth_sandstone_arch = BLOCKS.register("smooth_sandstone_arch", () ->  new ArchBlock( Blocks.SMOOTH_SANDSTONE));
		public static final Supplier<Block> stone_brick_arch = BLOCKS.register("stone_brick_arch", () ->  new ArchBlock( Blocks.STONE_BRICKS));
		public static final Supplier<Block> stone_arch = BLOCKS.register("stone_arch", () ->  new ArchBlock( Blocks.STONE));

		/*Vertical Slabs*/
		public static final Supplier<Block> oak_vertical_slab = BLOCKS.register("oak_vertical_slab", () -> new VerticalSlab(Blocks.OAK_PLANKS));
		public static final Supplier<Block> spruce_vertical_slab = BLOCKS.register("spruce_vertical_slab", () -> new VerticalSlab(Blocks.SPRUCE_PLANKS));
        public static final Supplier<Block> birch_vertical_slab = BLOCKS.register("birch_vertical_slab", () -> new VerticalSlab(Blocks.BIRCH_PLANKS));
        public static final Supplier<Block> jungle_vertical_slab = BLOCKS.register("jungle_vertical_slab", () -> new VerticalSlab(Blocks.JUNGLE_PLANKS));
        public static final Supplier<Block> acacia_vertical_slab = BLOCKS.register("acacia_vertical_slab", () -> new VerticalSlab(Blocks.ACACIA_PLANKS));
        public static final Supplier<Block> dark_oak_vertical_slab = BLOCKS.register("dark_oak_vertical_slab", () -> new VerticalSlab(Blocks.DARK_OAK_PLANKS));
        public static final Supplier<Block> purpur_vertical_slab = BLOCKS.register("purpur_vertical_slab", () -> new VerticalSlab(Blocks.PURPUR_BLOCK));
        public static final Supplier<Block> cobblestone_vertical_slab = BLOCKS.register("cobblestone_vertical_slab", () -> new VerticalSlab(Blocks.COBBLESTONE));
        public static final Supplier<Block> brick_vertical_slab = BLOCKS.register("brick_vertical_slab", () -> new VerticalSlab(Blocks.BRICKS));
        public static final Supplier<Block> stone_brick_vertical_slab = BLOCKS.register("stone_brick_vertical_slab", () -> new VerticalSlab(Blocks.STONE_BRICKS));
        public static final Supplier<Block> nether_brick_vertical_slab = BLOCKS.register("nether_brick_vertical_slab", () -> new VerticalSlab(Blocks.NETHER_BRICKS));
        public static final Supplier<Block> sandstone_vertical_slab = BLOCKS.register("sandstone_vertical_slab", () -> new VerticalSlab(Blocks.SANDSTONE));
        public static final Supplier<Block> quartz_vertical_slab = BLOCKS.register("quartz_vertical_slab", () -> new VerticalSlab(Blocks.QUARTZ_BLOCK));
        public static final Supplier<Block> prismarine_vertical_slab = BLOCKS.register("prismarine_vertical_slab", () -> new VerticalSlab(Blocks.PRISMARINE));
        public static final Supplier<Block> prismarine_brick_vertical_slab = BLOCKS.register("prismarine_brick_vertical_slab", () -> new VerticalSlab(Blocks.PRISMARINE_BRICKS));
        public static final Supplier<Block> dark_prismarine_vertical_slab = BLOCKS.register("dark_prismarine_vertical_slab", () -> new VerticalSlab(Blocks.DARK_PRISMARINE));
        public static final Supplier<Block> red_sandstone_vertical_slab = BLOCKS.register("red_sandstone_vertical_slab", () -> new VerticalSlab(Blocks.RED_SANDSTONE));
        public static final Supplier<Block> polished_granite_vertical_slab = BLOCKS.register("polished_granite_vertical_slab", () -> new VerticalSlab(Blocks.POLISHED_GRANITE));
        public static final Supplier<Block> smooth_red_sandstone_vertical_slab = BLOCKS.register("smooth_red_sandstone_vertical_slab", () -> new VerticalSlab(Blocks.SMOOTH_RED_SANDSTONE));
        public static final Supplier<Block> mossy_stone_brick_vertical_slab = BLOCKS.register("mossy_stone_brick_vertical_slab", () -> new VerticalSlab(Blocks.MOSSY_STONE_BRICKS));
        public static final Supplier<Block> polished_diorite_vertical_slab = BLOCKS.register("polished_diorite_vertical_slab", () -> new VerticalSlab(Blocks.POLISHED_DIORITE));
        public static final Supplier<Block> mossy_cobblestone_vertical_slab = BLOCKS.register("mossy_cobblestone_vertical_slab", () -> new VerticalSlab(Blocks.MOSSY_COBBLESTONE));
        public static final Supplier<Block> end_stone_brick_vertical_slab = BLOCKS.register("end_stone_brick_vertical_slab", () -> new VerticalSlab(Blocks.END_STONE_BRICKS));
        public static final Supplier<Block> stone_vertical_slab = BLOCKS.register("stone_vertical_slab", () -> new VerticalSlab(Blocks.STONE));
        public static final Supplier<Block> smooth_sandstone_vertical_slab = BLOCKS.register("smooth_sandstone_vertical_slab", () -> new VerticalSlab(Blocks.SMOOTH_SANDSTONE));
        public static final Supplier<Block> smooth_quartz_vertical_slab = BLOCKS.register("smooth_quartz_vertical_slab", () -> new VerticalSlab(Blocks.SMOOTH_QUARTZ));
        public static final Supplier<Block> granite_vertical_slab = BLOCKS.register("granite_vertical_slab", () -> new VerticalSlab(Blocks.GRANITE));
        public static final Supplier<Block> andesite_vertical_slab = BLOCKS.register("andesite_vertical_slab", () -> new VerticalSlab(Blocks.ANDESITE));
        public static final Supplier<Block> red_nether_brick_vertical_slab = BLOCKS.register("red_nether_brick_vertical_slab", () -> new VerticalSlab(Blocks.RED_NETHER_BRICKS));
        public static final Supplier<Block> polished_andesite_vertical_slab = BLOCKS.register("polished_andesite_vertical_slab", () -> new VerticalSlab(Blocks.POLISHED_ANDESITE));
        public static final Supplier<Block> diorite_vertical_slab = BLOCKS.register("diorite_vertical_slab", () -> new VerticalSlab(Blocks.DIORITE));
        public static final Supplier<Block> smooth_stone_vertical_slab = BLOCKS.register("smooth_stone_vertical_slab", () -> new VerticalSlab(Blocks.SMOOTH_STONE));

		/*Vertical Stairs*/
		 public static final Supplier<Block> oak_vertical_stairs = BLOCKS.register("oak_vertical_stairs", () -> new VerticalStairs(Blocks.OAK_PLANKS));
         public static final Supplier<Block> spruce_vertical_stairs = BLOCKS.register("spruce_vertical_stairs", () -> new VerticalStairs(Blocks.SPRUCE_PLANKS));
         public static final Supplier<Block> birch_vertical_stairs = BLOCKS.register("birch_vertical_stairs", () -> new VerticalStairs(Blocks.BIRCH_PLANKS));
         public static final Supplier<Block> jungle_vertical_stairs = BLOCKS.register("jungle_vertical_stairs", () -> new VerticalStairs(Blocks.JUNGLE_PLANKS));
         public static final Supplier<Block> acacia_vertical_stairs = BLOCKS.register("acacia_vertical_stairs", () -> new VerticalStairs(Blocks.ACACIA_PLANKS));
         public static final Supplier<Block> dark_oak_vertical_stairs = BLOCKS.register("dark_oak_vertical_stairs", () -> new VerticalStairs(Blocks.DARK_OAK_PLANKS));
         public static final Supplier<Block> purpur_vertical_stairs = BLOCKS.register("purpur_vertical_stairs", () -> new VerticalStairs(Blocks.PURPUR_BLOCK));
         public static final Supplier<Block> cobblestone_vertical_stairs = BLOCKS.register("cobblestone_vertical_stairs", () -> new VerticalStairs(Blocks.COBBLESTONE));
         public static final Supplier<Block> brick_vertical_stairs = BLOCKS.register("brick_vertical_stairs", () -> new VerticalStairs(Blocks.BRICKS));
         public static final Supplier<Block> stone_brick_vertical_stairs = BLOCKS.register("stone_brick_vertical_stairs", () -> new VerticalStairs(Blocks.STONE_BRICKS));
         public static final Supplier<Block> nether_brick_vertical_stairs = BLOCKS.register("nether_brick_vertical_stairs", () -> new VerticalStairs(Blocks.NETHER_BRICKS));
         public static final Supplier<Block> sandstone_vertical_stairs = BLOCKS.register("sandstone_vertical_stairs", () -> new VerticalStairs(Blocks.SANDSTONE));
         public static final Supplier<Block> quartz_vertical_stairs = BLOCKS.register("quartz_vertical_stairs", () -> new VerticalStairs(Blocks.QUARTZ_BLOCK));
         public static final Supplier<Block> prismarine_vertical_stairs = BLOCKS.register("prismarine_vertical_stairs", () -> new VerticalStairs(Blocks.PRISMARINE));
         public static final Supplier<Block> prismarine_brick_vertical_stairs = BLOCKS.register("prismarine_brick_vertical_stairs", () -> new VerticalStairs(Blocks.PRISMARINE_BRICKS));
         public static final Supplier<Block> dark_prismarine_vertical_stairs = BLOCKS.register("dark_prismarine_vertical_stairs", () -> new VerticalStairs(Blocks.DARK_PRISMARINE));
         public static final Supplier<Block> red_sandstone_vertical_stairs = BLOCKS.register("red_sandstone_vertical_stairs", () -> new VerticalStairs(Blocks.RED_SANDSTONE));
         public static final Supplier<Block> polished_granite_vertical_stairs = BLOCKS.register("polished_granite_vertical_stairs", () -> new VerticalStairs(Blocks.POLISHED_GRANITE));
         public static final Supplier<Block> smooth_red_sandstone_vertical_stairs = BLOCKS.register("smooth_red_sandstone_vertical_stairs", () -> new VerticalStairs(Blocks.SMOOTH_RED_SANDSTONE));
         public static final Supplier<Block> mossy_stone_brick_vertical_stairs = BLOCKS.register("mossy_stone_brick_vertical_stairs", () -> new VerticalStairs(Blocks.MOSSY_STONE_BRICKS));
         public static final Supplier<Block> polished_diorite_vertical_stairs = BLOCKS.register("polished_diorite_vertical_stairs", () -> new VerticalStairs(Blocks.POLISHED_DIORITE));
         public static final Supplier<Block> mossy_cobblestone_vertical_stairs = BLOCKS.register("mossy_cobblestone_vertical_stairs", () -> new VerticalStairs(Blocks.MOSSY_COBBLESTONE));
         public static final Supplier<Block> end_stone_brick_vertical_stairs = BLOCKS.register("end_stone_brick_vertical_stairs", () -> new VerticalStairs(Blocks.END_STONE_BRICKS));
         public static final Supplier<Block> stone_vertical_stairs = BLOCKS.register("stone_vertical_stairs", () -> new VerticalStairs(Blocks.STONE));
         public static final Supplier<Block> smooth_sandstone_vertical_stairs = BLOCKS.register("smooth_sandstone_vertical_stairs", () -> new VerticalStairs(Blocks.SMOOTH_SANDSTONE));
         public static final Supplier<Block> smooth_quartz_vertical_stairs = BLOCKS.register("smooth_quartz_vertical_stairs", () -> new VerticalStairs(Blocks.SMOOTH_QUARTZ));
         public static final Supplier<Block> granite_vertical_stairs = BLOCKS.register("granite_vertical_stairs", () -> new VerticalStairs(Blocks.GRANITE));
         public static final Supplier<Block> andesite_vertical_stairs = BLOCKS.register("andesite_vertical_stairs", () -> new VerticalStairs(Blocks.ANDESITE));
         public static final Supplier<Block> red_nether_brick_vertical_stairs = BLOCKS.register("red_nether_brick_vertical_stairs", () -> new VerticalStairs(Blocks.RED_NETHER_BRICKS));
         public static final Supplier<Block> polished_andesite_vertical_stairs = BLOCKS.register("polished_andesite_vertical_stairs", () -> new VerticalStairs(Blocks.POLISHED_ANDESITE));
         public static final Supplier<Block> diorite_vertical_stairs = BLOCKS.register("diorite_vertical_stairs", () -> new VerticalStairs(Blocks.DIORITE));
