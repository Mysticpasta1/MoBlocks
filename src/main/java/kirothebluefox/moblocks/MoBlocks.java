...
//	public static ConfigImplementation config;
    ...
    public static final CreativeModeTab special_blocks_creative_tab = CreativeModeTab.builder().withTabsImage(ModBlocks.OAK_ARCH).build();
    public static final CreativeModeTab decoration_creative_tab = CreativeModeTab.builder().withTabsImage(ModBlocks.COLORABLE_FLOWER_POT).build();
    public static final CreativeModeTab furnitures_creative_tab = CreativeModeTab.builder().withTabsImage(ModBlocks.OAK_TABLE).build();
